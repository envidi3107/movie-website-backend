...
public class FilmController {
  ...
  public PageResponse<FilmSummaryResponse> searchFilms(
    ...
    List<FilmSummaryResponse> content =
        pageRes.getContent().stream().map(filmService::mapToSummary).collect(Collectors.toList());
  ...
  @PostMapping(value = "/{filmId}/episodes", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)

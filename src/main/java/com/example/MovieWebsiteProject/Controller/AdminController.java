...
public class AdminController {
    ...
    public ApiResponse<List<Map<String, Object>>> getMonthlyNewUsers() {
        return ApiResponse.<List<Map<String, Object>>>builder().code(SuccessCode.SUCCESS.getCode()).message(SuccessCode.SUCCESS.getMessage()).results(adminService.getMonthlyNewUsers()).build();
    }

    @GetMapping("/top-user-like")
    public ApiResponse<List<Map<String, Object>>> getTopUserLike(@RequestParam("limit") int limit) {
        return ApiResponse.<List<Map<String, Object>>>builder().code(SuccessCode.SUCCESS.getCode()).message(SuccessCode.SUCCESS.getMessage()).results(adminService.getTopUserLike(limit)).build();
    }

    @GetMapping("/popular-hours")
    public ApiResponse<List<PopularHourResponse>> getPopularHours() {
        return ApiResponse.<List<PopularHourResponse>>builder().code(SuccessCode.SUCCESS.getCode()).message(SuccessCode.SUCCESS.getMessage()).results(adminService.getMostPopularHours()).build();
    }
    ...
    public ApiResponse<String> uploadFilm(@Valid @ModelAttribute FilmRequest request) {
        ...
        return ApiResponse.<String>builder().code(SuccessCode.UPLOAD_FILM_SUCCESSFULLY.getCode()).message(SuccessCode.UPLOAD_FILM_SUCCESSFULLY.getMessage()).results(filmId).build();
    }
    ...
    public ApiResponse<String> updateFilm(
        ...
        return ApiResponse.<String>builder().code(SuccessCode.UPDATE_FILM_SUCCESSFULLY.getCode()).message(SuccessCode.UPDATE_FILM_SUCCESSFULLY.getMessage()).results(updatedId).build();
    }
    ...
    public ApiResponse<String> deleteFilm(@PathVariable("filmId") String filmId) {
        ...
        return ApiResponse.<String>builder().code(SuccessCode.DELETE_FILM_SUCCESSFULLY.getCode()).message(SuccessCode.DELETE_FILM_SUCCESSFULLY.getMessage()).results(SuccessCode.DELETE_FILM_SUCCESSFULLY.getMessage()).build();
    }

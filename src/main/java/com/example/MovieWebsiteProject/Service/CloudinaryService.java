...
public class CloudinaryService {
  ...
  public String uploadImage(MultipartFile file) throws IOException {
    Map uploadResult =
        cloudinary.uploader().upload(file.getBytes(), ObjectUtils.asMap("folder", "Image"));
  ...
  public String updateImage(String publicId, MultipartFile file) throws Exception {
    Map updateResult =
        cloudinary
            ...
            .upload(
                file.getBytes(),
                ObjectUtils.asMap("public_id", publicId, "folder", "Image", "overwrite", true));
  ...
  public void deleteVideo(String publicId) {
    ...
    try {
      cloudinary
          .uploader()
          .destroy(publicId, ObjectUtils.asMap("resource_type", "video", "invalidate", true));
    } catch (Exception e) {
      throw new RuntimeException(e.getMessage());
    }
  }
